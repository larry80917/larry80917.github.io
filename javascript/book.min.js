...
try{console&&console.error&&console.error.apply(console,arguments)}catch(b){}this.logForPad(String.format.apply(this,arguments),"red")}},print:function(){var b=String.format.apply(this,arguments),c=(new Date).format("hh:mm:ss.S");this.debug("[%s] %s",c,b)}}}),VERSION_NAME="6.4.9",BUILD_DATE="2024040101",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},
...
this.page.resetSlider()},initReaderOrSlider:function(){this.page&&this.page.initReaderOrSlider()},destroySlider:function(){this.page&&this.page.destroySlider()}});bdor[30]=function(b,c){return bdor[b]-c};bdor[38]=function(){return bdor[30](37,40)}();
...
2,totalPageCount].indexOf(b)||totalPageCount!=c&&totalPageCount!=b?!1:!0},toHardPage:function(b){return 0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(this.currentPageIndex)&&0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(b)?!1:!0},toCoverPage:function(b){return totalPageCount!=this.currentPageIndex&&totalPageCount!=b?!1:!0},isHardPage:function(b,c){return b==totalPageCount||b==totalPageCount-1?!1:!0},isCoverPage:function(b,c){return b==totalPageCount||b==totalPageCount-
1?!0:!1},gotoNearPage:function(b){this.currentPageIndex==totalPageCount?gotoPageFun(totalPageCount-1,!1,"cross page"):b==totalPageCount&&gotoPageFun(totalPageCount-1,!1,"cross page")},newPage:function(b){return 1==b||b==totalPageCount||b==totalPageCount-1?new HardPage(b,"page",!1,BookType.normal_book):new AlbumPage(b,"page",!1,BookType.normal_book)}}).extend(AlbumHardBook),SingleAlbumBook=Class({bookType:BookType.single_book,create:function(b){this._super(b)},crossFlipMode:function(b){return!1},toSoftPage:function(b){return!1},
toHardPage:function(b){return!0},isHardPage:function(b,c){return!0},toCoverPage:function(){return!1},isCoverPage:function(){return!1},gotoNearPage:function(b){},newPage:function(b){return new AlbumPage(b,"page",!0,BookType.single_book)},getDownUpHardPage:function(b,c){var d=b;b>c&&(d=c);this.addPageArray([d]);this.addPageBackArray([d]);bookConfig.RightToLeft?(this.pageArray[d]&&this.pageArray[d].setLeftOrRight(!0),this.pageBackArray[d]&&this.pageBackArray[d].setLeftOrRight(!0),this.pageArray[d]&&
this.pageArray[d].setCSSByName("flip-hard-left-side"),this.pageBackArray[d]&&this.pageBackArray[d].setCSSByName("flip-hard-right-side")):(this.pageArray[d]&&this.pageArray[d].setLeftOrRight(!1),this.pageBackArray[d]&&this.pageBackArray[d].setLeftOrRight(!1),this.pageArray[d]&&this.pageArray[d].setCSSByName("flip-hard-right-side"),this.pageBackArray[d]&&this.pageBackArray[d].setCSSByName("flip-hard-left-side"));return[this.pageArray[d],this.pageBackArray[d]]}}).extend(SingleBook),SingleAlbumHardBook=
